    ...
    >
      ...
      >
        <Link
            ...
            mr={{ base: 0, md: 10 }}
          >
            <Image src="/static/images/halloween_uniskai_header.png" alt="uniskai" fill />
          </Link>
      </Box>
      <Flex
        flexDir={"column"}
      ...
      >
        <Flex flexDir="column" mb={{ base: 10, lg: 0 }}>
          <Text fontWeight={600} color={"orange"} letterSpacing={3} mb={3}>
            CONTACT US
          </Text>
        ...
        <Flex 
          ...
          mr={{ base: 0, md: 10 }} 
        >
          <Text fontWeight={600} color={"orange"} letterSpacing={3} mb={1}>
              SOCIAL MEDIA
          </Text>
        </Flex>
        <Flex
